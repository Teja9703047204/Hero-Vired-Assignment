...
public class Q3 {
    public static void main(String[] args) {
        ...
        String[] specifications = { "6gb ram 128 gb memory snap dragon 888", "Ryzen 5,8gb ram,512gb ssd",
                "wired and 3mm spekers", "bluetooth earphones" };
    ...
    static void viewProductDetails(String[] products, String[] specifications, int[] count, int[] prices) {
        for (int i = 0; i < 4; i++) {
            System.out.println(i + 1 + " category:" + products[i] + " specifications:" + specifications[i]
                    + " products avilaible:" + count[i] + " prices:" + products[i]);
        }
    }
    ...
    static void editProduct(String[] products, String[] specification, int incremnetIndex, String change) {
        ...
        System.out.println("the product " + products[incremnetIndex - 1] + " specification changed to "
                + specification[incremnetIndex - 1]);
    ...
    static void updateInventory(String[] products, int[] count, int incrementIndex, int countt) {
        ...
        System.out.println("after changes product  :" + products[incrementIndex - 1] + " have new count :"
                + count[incrementIndex - 1]);
    }
